...
- (void) application: (UIApplication *)application didReceiveLocalNotification:(nonnull UILocalNotification *)notification {
    ...
    UIAlertController *alertCon = [UIAlertController alertControllerWithTitle:@"PROMOTION!" message:notification.alertBody preferredStyle:UIAlertControllerStyleAlert];
